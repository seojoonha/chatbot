...
namespace my_first_chatbot.Helper.StoredStringValues
{
    ...
    public class StoredStringValuesMaster
    {
        ...
        public string _typePleaseWelcome = 
                                    $"안녕하세요 AAR 챗봇서비스입니다.\n" +
                                    $"원하시는 메뉴의 번호를 선택하시거나 질문을 입력해주세요.\n\n" +
                                    $"1. 수강신청정보\n" +
                                    $"2. 과목정보\n" +
                                    $"3. 학점관리\n" +
                                    $"4. 기타정보\n" +
        ...
        //aboutCourseInfo
        public string _courseInfoSelected = 
                                    $"강의 정보를 선택하셨습니다.\n" +
                                    $"세부항목을 선택해주세요.";
        ...
        public string _courseRegistrationSelected = 
                                    $"수강 신청을 선택하셨습니다.\n" +
                                    $"세부항목을 선택해주세요.";
        ...
        //aboutCredits
        public string _creditsOptionSelected = 
                                    $"학점 관리를 선택하셨습니다.\n" +
                                    $"세부항목을 선택해주세요.";
        ...
        //aboutOthers
        public string _otherOptionSelected = 
                                    $"기타 정보를 선택하셨습니다.\n" +
                                    $"세부항목을 선택해주세요.";
